...
public class MainEmployee {
	...
	public static void main(String[] args) {
		...
		Employee e1=new Employee("Kishor","it",10,15000);
		Employee e2=new Employee("Nagesh","abc",25,20000);
		Employee e3=new Employee("Vicky","pqr",18,30000);
		Employee e4=new Employee("Vivek","xyz",22,35000);
		Employee e5=new Employee("Sudesh","qvw",16,7000);
		Employee e6=new Employee("Nilesh","wwww",20,19000);
		ep.add(e1);
		ep.add(e2);
		ep.add(e3);
		ep.add(e4);
		...
		System.out.println("highest Sallary"+ep.stream().max((p1,p2)->p1.getSal()>p2.getSal()?1:-1).map(e->e.getName()));
